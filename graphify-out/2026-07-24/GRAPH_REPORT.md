# Graph Report - JobAssistantAI  (2026-07-24)

## Corpus Check
- 306 files · ~109,325 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2263 nodes · 4262 edges · 175 communities (135 shown, 40 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 586 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8f09e711`
...
5. `apiRequest()` - 39 edges
6. `Profile` - 36 edges
7. `ProfileService` - 36 edges
...
## Communities (175 total, 40 thin omitted)

### Community 0 - "Backend API Endpoints & Errors"
Cohesion: 0.18
Nodes (9): health(), sync_job_postings(), Run a single ATS sync pass and persist results. Safe to call from a     request, run_sync_once(), get_settings(), _ats_sync_loop(), create_app(), lifespan() (+1 more)

### Community 1 - "AI Provider Adapters (Ollama/OpenAI)"
Cohesion: 0.06
Nodes (35): ollama_compatible_schema(), OllamaProvider, Any, BaseModel, OutputT, ProviderInfo, Keep structural validation while removing grammar-unsupported annotations., _strip_unsupported_schema_keys() (+27 more)

### Community 2 - "Profiles API & Common Schemas"
Cohesion: 0.07
Nodes (53): list_job_postings(), add_profile_fact(), create_profile(), delete_profile_fact(), get_profile(), list_profiles(), profile_id(), FactVerificationRequest (+45 more)

### Community 3 - "Repositories & Docling Parsing"
Cohesion: 0.09
Nodes (29): _best_matching_element(), _canonical_category(), _element_chunks(), extract_candidate_facts(), _tokens(), validate_extracted_facts(), DoclingParser, _needs_ocr() (+21 more)
...
Cohesion: 0.19
Nodes (10): Remove records and artifacts created by executable smoke journeys., register_job(), register_profile(), main(), Backend-backed fictional profile create/edit/verify journey., request(), seed_parser_fact(), main() (+2 more)
...
Cohesion: 0.15
Nodes (10): ConfidenceBadge(), Entry, FieldMappingRow(), Badge(), BadgeProps, badgeVariants, Checkbox(), Progress() (+2 more)

### Community 10 - "Document Processing Service"
Cohesion: 0.08
Nodes (43): navigation, Sheet(), SheetContent(), SheetDescription(), SheetFooter(), SheetHeader(), SheetOverlay(), SheetTitle() (+35 more)

### Community 11 - "Match Scoring Pipeline"
Cohesion: 0.12
Nodes (21): jobPostingsQueryKey(), listJobPostings(), quickApplyToJobPosting(), Dialog(), DialogContent(), DialogDescription(), DialogFooter(), DialogHeader() (+13 more)
...
Cohesion: 0.11
Nodes (23): analyzeJob(), scoreMatch(), reviewDocumentChange(), tailorDocuments(), ErrorState(), backendMaxUnlocked(), isScanReadOnly(), StartApplicationFlow() (+15 more)
...
Cohesion: 0.08
Nodes (26): SidebarContent(), SidebarContext, SidebarContextProps, SidebarFooter(), SidebarGroup(), SidebarGroupAction(), SidebarGroupContent(), SidebarGroupLabel() (+18 more)
...
Cohesion: 0.40
Nodes (4): ScoreRing(), labels, MatchView(), BackendMatch
...
Cohesion: 0.11
Nodes (25): getSourcePreview(), reprocessDocument(), backendCandidateFactSchema, BackendMatch, BackendProfile, backendProfileSchema, customSectionSchema, DocumentParse (+17 more)

### Community 28 - "Dashboard Pages & Navigation"
Cohesion: 0.14
Nodes (25): getProviders(), providersQueryKey, saveAiPreference(), testProvider(), profileQueryKey(), Card(), CardAction(), CardContent() (+17 more)
...
Cohesion: 0.16
Nodes (16): Badge(), badgeVariants, Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader() (+8 more)
...
Cohesion: 0.10
Nodes (20): ReadinessSummary(), Change, ChangeCard(), Button(), buttonVariants, Input(), ConfirmView(), ApplicationsPage() (+12 more)
...
Cohesion: 0.11
Nodes (25): analyzeJob(), scoreMatch(), reviewDocumentChange(), tailorDocuments(), clearActiveProfileId(), getSnapshot(), refreshCache(), subscribe() (+17 more)
...
Cohesion: 0.14
Nodes (12): Operation, Profile, OperationRepository, ProfileRepository, Session, UUID, Repository, OperationService (+4 more)
...
Cohesion: 0.26
Nodes (10): emit(), get(), keyFor(), listeners, readValue(), remove(), set(), StorageChange (+2 more)
...
Cohesion: 0.24
Nodes (12): get_engine(), get_session(), get_session_factory(), Session, create_profile(), main(), process(), Client (+4 more)
...
### Community 83 - "main"
Cohesion: 0.23
Nodes (9): DashboardShell(), profileIdentity(), ProfilePage(), ActiveProfileState, deriveActiveProfileState(), ProfileSetup(), ActiveIdentifiers, initialIdentifiers (+1 more)
...
Cohesion: 0.06
Nodes (53): apiRequest(), executeParse(), uploadDocument(), addProfileFact(), createProfile(), deleteProfileFact(), getProfile(), listProfiles() (+45 more)

### Community 97 - "App.tsx"
Cohesion: 0.11
Nodes (14): BackendConnection, BackendError, connection(), getOverview(), overviewQueryKey(), queryClient, NAV, NavItem (+6 more)

### Community 98 - "JobPostingQueryService"
Cohesion: 0.14
Nodes (12): QuickApplyResponse, Session, quick_apply(), LeverQuickApplyClient, Client, Submits an application through Lever's public posting apply form.      Lever's h, _parse_uuid(), QuickApplyResponse (+4 more)

### Community 99 - "state.ts"
Cohesion: 0.11
Nodes (20): mockApplications, statuses, mockCandidate, mockDocuments, coreFields, mockJob, mockMatchResult, mockSession (+12 more)
...
Cohesion: 0.10
Nodes (25): ProviderRegistry, ProviderId, Session, upload_document(), Settings, ApplicationStatus, OperationStatus, ProfileReadiness (+17 more)
...
Cohesion: 0.17
Nodes (16): Session, score_match(), JobRequirementOutput, AggregatedMatch, CandidateEvidenceOutput, EvidenceClassification, MatchItem, MatchScoreRequest (+8 more)
...
Cohesion: 0.24
Nodes (11): A4Page(), ApplicationRecord, ApplicationStatus, GeneratedDocuments, tailoredChangeSchema, tailoredClassificationSchema, FillPlan, Job (+3 more)

### Community 127 - "React + TypeScript + Vite"
Cohesion: 0.50
Nodes (3): Expanding the Oxlint configuration, React Compiler, React + TypeScript + Vite

### Community 152 - "@base-ui/react"
Cohesion: 0.20
...
### Community 164 - "tw-animate-css"
Cohesion: 0.36
Nodes (5): listProfiles(), selectActiveProfile(), readinessLabel, SidebarProfileSelector(), browser

### Community 173 - "execute_operation"
Cohesion: 0.24
Nodes (6): execute_operation(), Request, Session, DocumentParseResponse, main(), Standalone entrypoint for the job postings ATS sync.  Runs one sync pass against

## Knowledge Gaps
- **619 isolated node(s):** `$schema`, `react`, `typescript`, `oxc`, `react/rules-of-hooks` (+614 more)
...
- **Why does `DomainError` connect `JobAnalyzeRequest` to `Backend API Endpoints & Errors`, `AI Provider Adapters (Ollama/OpenAI)`, `Profiles API & Common Schemas`, `JobPostingQueryService`, `Operation`, `SQLAlchemy Domain Entities`, `execute_operation`, `Application Store Actions`, `Runtime Mock Validation`, `client.ts`, `Application Store & Result Type`, `Match Evidence Cards`, `@base-ui/react`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `ApiModel` connect `Profiles API & Common Schemas` to `AI Provider Adapters (Ollama/OpenAI)`, `JobPostingQueryService`, `Repositories & Docling Parsing`, `Operation`, `execute_operation`, `Application Store Actions`, `client.ts`, `JobAnalyzeRequest`, `Application Store & Result Type`, `Match Evidence Cards`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `cn()` connect `Document Processing Service` to `document.ts`, `tw-animate-css`, `Source Preview Service`, `Match Scoring Pipeline`, `profile.ts`, `Fact Review UI Components`, `Dashboard Pages & Navigation`?**
...
- **Should `AI Provider Adapters (Ollama/OpenAI)` be split into smaller, more focused modules?**
