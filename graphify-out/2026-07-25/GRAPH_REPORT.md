...
## Corpus Check
- 314 files · ~116,117 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2363 nodes · 4502 edges · 191 communities (148 shown, 43 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 599 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8b309721`
...
Cohesion: 0.11
Nodes (29): add_profile_fact(), create_profile(), delete_profile(), delete_profile_fact(), get_profile(), list_profiles(), profile_id(), FactVerificationRequest (+21 more)

### Community 3 - "Repositories & Docling Parsing"
Cohesion: 0.07
Nodes (45): _best_matching_element(), _canonical_category(), _element_chunks(), extract_candidate_facts(), _extract_whole_document(), Section-guided hybrid extraction.      Contact/summary/skills/certs are pulled d, _run_section_llm(), _tokens() (+37 more)
...
Cohesion: 0.14
Nodes (16): Remove records and artifacts created by executable smoke journeys., register_job(), register_profile(), main(), Backend-backed fictional profile create/edit/verify journey., request(), main(), Validate safe provider discovery, connection checks, and saved preferences. (+8 more)
...
Cohesion: 0.21
Nodes (12): getProviders(), providersQueryKey, saveAiPreference(), testProvider(), PROVIDER_DESC, SettingsPage(), STATUS_LABEL, STATUS_TONE (+4 more)

### Community 10 - "Document Processing Service"
Cohesion: 0.07
Nodes (46): DashboardShell(), navigation, profileIdentity(), Separator(), Sheet(), SheetContent(), SheetDescription(), SheetFooter() (+38 more)

### Community 11 - "Match Scoring Pipeline"
Cohesion: 0.20
Nodes (14): JobRequirementOutput, AggregatedMatch, CandidateEvidenceOutput, EvidenceClassification, MatchItem, MatchScoreRequest, MatchScoreResponse, str (+6 more)

### Community 12 - "SQLAlchemy Domain Entities"
Cohesion: 0.23
Nodes (16): ParseRun, ProfileFact, SourceDocument, _clamp(), _fact_page(), _normalized_box(), _paginate_elements(), Any (+8 more)
...
Cohesion: 0.17
Nodes (12): 17. Phase 2 goal, 18. Backend technology, 20. Minimum API, 21. Minimum database entities, 22. Extension/backend integration, 23. Phase 2 acceptance gate, 24. Phase 2 explicitly out of scope, 25. POC definition of done (+4 more)
...
Cohesion: 0.29
Nodes (11): ApiModel, BaseModel, SourceReference, ErrorDetail, ErrorEnvelope, CandidateFact, FactCreateRequest, FactVerification (+3 more)

### Community 20 - "Mock Fixtures & Validation"
Cohesion: 0.13
Nodes (16): analyzeJob(), scoreMatch(), ScoreRing(), ErrorState(), backendMaxUnlocked(), isScanReadOnly(), StartApplicationFlow(), stepOrder (+8 more)
...
Cohesion: 0.14
Nodes (18): DocumentTailorResponse, Session, review_document_change(), tailor_documents(), ReviewStatus, CoverLetterDocumentOutput, DocumentChangeOutput, DocumentChangeReviewRequest (+10 more)
...
Cohesion: 0.09
Nodes (28): getSourcePreview(), reprocessDocument(), backendCandidateFactSchema, BackendMatch, backendMatchSchema, BackendProfile, backendProfileSchema, customSectionSchema (+20 more)
...
Cohesion: 0.10
Nodes (21): ReadinessSummary(), A4Page(), Change, ChangeCard(), Button(), buttonVariants, Input(), ConfirmView() (+13 more)
...
Cohesion: 0.26
Nodes (6): execute_operation(), Request, Session, FilesystemStorage, BinaryIO, Path
...
Cohesion: 0.13
Nodes (23): createApplication(), apiRequest(), BackendConnection, BackendError, connection(), analyzeJob(), scoreMatch(), queryClient (+15 more)
...
Cohesion: 0.22
Nodes (9): mockApplications, statuses, applicationRecordSchema, trackedApplicationStatusSchema, applicationStatusSchema, confidenceSchema, matchClassificationSchema, matchItemSchema (+1 more)
...
Cohesion: 0.23
Nodes (7): err(), ok(), Result, SessionRepository, allowedTransitions, createApplicationStore(), initialState
...
Cohesion: 0.18
Nodes (17): enqueueAutoApply(), jobPostingsQueryKey(), listJobPostings(), quickApplyToJobPosting(), BrowseJobsPage(), FILTERS, postedLabel(), Sort (+9 more)
...
Cohesion: 0.32
Nodes (7): get_engine(), get_session(), get_session_factory(), Session, cleanup(), Engine, sessionmaker
...
Cohesion: 0.11
Nodes (19): dependencies, @base-ui/react, clsx, @fontsource-variable/geist, lucide-react, @radix-ui/react-checkbox, @radix-ui/react-select, react (+11 more)

### Community 91 - "validate_migrations.py"
Cohesion: 0.31
Nodes (16): Base, IdentifierMixin, TimestampMixin, AgentRun, Application, ApplicationEvent, DocumentChange, FillPlan (+8 more)
...
### Community 93 - "env.py"
Cohesion: 0.11
Nodes (19): cmdk, dependencies, clsx, cmdk, @fontsource-variable/inter, @fontsource-variable/plus-jakarta-sans, lucide-react, @radix-ui/react-tabs (+11 more)
...
Cohesion: 0.04
Nodes (66): addProfileFact(), deleteProfileFact(), verifyProfileFacts(), Combobox(), COMMON_TITLES, COUNTRIES, EARLIEST_START, ETHNICITIES (+58 more)

### Community 97 - "App.tsx"
Cohesion: 0.11
Nodes (25): getOverview(), overviewQueryKey(), deleteProfile(), getProfile(), listProfiles(), profileQueryKey(), setDefaultProfile(), updateProfile() (+17 more)

### Community 98 - "JobPostingQueryService"
Cohesion: 0.10
Nodes (17): list_job_postings(), LeverQuickApplyClient, Client, Submits an application through Lever's public posting apply form.      Lever's h, JobPostingQueryService, Session, _parse_uuid(), QuickApplyResponse (+9 more)

### Community 99 - "state.ts"
Cohesion: 0.21
Nodes (11): executeParse(), uploadDocument(), createProfile(), setActiveProfileId(), clearParsing(), emit(), listeners, markParsing() (+3 more)
...
### Community 102 - "entities.py"
Cohesion: 0.20
Nodes (10): 14.1 Permissions, 14.2 Extension messaging, 14.3 Page scan, 14.4 ATS adapter contract, 14.5 Field descriptors, 14.6 Filling behavior, 14.7 Backend-backed profile and attachments, 14.8 Backend scoring integration (+2 more)

### Community 103 - "session.ts"
Cohesion: 0.24
Nodes (5): cloneSeed(), MemorySessionRepository, MockSessionRepository, SessionLoadResult, PersistedSession

### Community 104 - "Operation"
Cohesion: 0.08
Nodes (27): Session, upload_document(), Settings, ApplicationStatus, Operation, OperationStatus, ProfileReadiness, str (+19 more)
...
### Community 109 - "profile.ts"
Cohesion: 0.20
Nodes (10): 19.1 Profiles, 19.2 Document ingestion, 19.3 Docling adapter, 19.4 Job analysis, 19.5 Scoring, 19.6 AI provider, 19.7 Tailoring, 19.8 A4 preview and PDF (+2 more)
...
Cohesion: 0.20
Nodes (9): domain_error_response(), error_response(), Any, DevelopmentBearerTokenMiddleware, Request, Response, BaseHTTPMiddleware, JSONResponse (+1 more)

### Community 115 - "JobAnalyzeRequest"
Cohesion: 0.19
Nodes (9): mockCandidate, coreFields, mockJob, mockMatchResult, mockSession, fieldDescriptorSchema, jobSchema, candidateProfileSchema (+1 more)

### Community 117 - "main"
Cohesion: 0.29
Nodes (6): mockFillPlan, fieldConfidenceSchema, fieldSensitivitySchema, fillEntryStatusSchema, fillPlanEntrySchema, fillPlanSchema

### Community 118 - "validate_document"
Cohesion: 0.19
Nodes (15): getSourcePreview(), sourcePreviewQueryKey(), getProfile(), profileQueryKey(), verifyProfileFacts(), ProfilePage(), ActiveProfileState, deriveActiveProfileState() (+7 more)

### Community 119 - "scan-view.tsx"
Cohesion: 0.22
Nodes (8): 11. Phase 1 acceptance gate, 12. Phase 1 explicitly out of scope, 13. Phase 3 goal, 15. Phase 3 acceptance gate, 16. Phase 3 explicitly out of scope, 9. Phase 1 goal, Phase 1: Extension UI with mock data, Phase 3: Browser integration and complete workflow
...
### Community 122 - "BackendError"
Cohesion: 0.25
Nodes (8): 10.1 Manifest and extension entry points, 10.2 React UI foundation, 10.3 shadcn/ui and CSS design system, 10.4 Zustand workflow model, 10.5 Mock data, 10.6 Side-panel interactions, 10.7 Workspace interactions, 10. Phase 1 implementation scope
...
### Community 126 - "badge.tsx"
Cohesion: 0.42
Nodes (8): ApplicationRecord, ApplicationStatus, GeneratedDocuments, FillPlan, Job, MatchResult, CandidateProfile, ApplicationState
...
Cohesion: 0.25
Nodes (6): ConfidenceBadge(), Entry, FieldMappingRow(), Checkbox(), Progress(), FillView()

### Community 155 - "radix-ui"
Cohesion: 0.33
Nodes (6): EvidenceRow(), MatchItem, Badge(), badgeVariants, CandidateFact, candidateFactSchema

### Community 160 - "@radix-ui/react-tabs"
Cohesion: 0.27
Nodes (8): tailorDocuments(), coverLetterDocumentSchema, DocumentChange, documentChangeReviewResponseSchema, documentChangeSchema, DocumentTailorResponse, documentTailorResponseSchema, resumeDocumentSchema

### Community 161 - "execute_operation"
Cohesion: 0.57
...
Cohesion: 0.60
Nodes (5): _document_id(), Session, UUID, reprocess_document(), source_preview()
...
### Community 177 - "react-dom"
Cohesion: 0.60
Nodes (3): parsedTextMatches(), ParsedSourceText(), SourcePreview
...
Cohesion: 0.17
Nodes (14): health(), QuickApplyResponse, Session, quick_apply(), sync_job_postings(), Session, score_match(), Run a single ATS sync pass and persist results. Safe to call from a     request (+6 more)
...
- **Why does `cn()` connect `Document Processing Service` to `document.ts`, `badge.tsx`, `radix-ui`, `react-dom`, `shadcn`, `useSidebar`, `Fact Review UI Components`, `radix-ui`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `ApiModel` connect `Application Store & Result Type` to `Backend API Endpoints & Errors`, `AI Provider Adapters (Ollama/OpenAI)`, `JobPostingQueryService`, `Repositories & Docling Parsing`, `Profiles API & Common Schemas`, `Operation`, `Match Scoring Pipeline`, `SQLAlchemy Domain Entities`, `Scan & Match Views`, `document.ts`, `Match Evidence Cards`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `cn()` connect `Application Store Actions` to `documents.tsx`, `dialog.tsx`, `sheet.tsx`, `@tanstack/react-query`, `Document API Client & Profile Setup`, `shadcn/ui Config`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
