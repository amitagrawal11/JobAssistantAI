...
export function ScanView() {
  ...
  return <div className="step-stack">
    ...
    <label className="field-label">Job description <Textarea value={draft} onChange={(event) => setDraft(event.target.value)} onBlur={() => void editJobDescription(draft)} /><span>{draft.length.toLocaleString()} characters · Edited text is authoritative</span></label>
